...
- **India strategic reserves** — ISPRL 5.33 MMT / 36.92 M bbl; the official ISPRL/MoPNG cover figure is **9.5 days** (on a net-import basis — do not divide it by the ~4.5 mb/d gross-import number above, the denominators differ); ~74 days incl. refiners' commercial stock; vs the **IEA 90-day** norm — [Wikipedia/ISPRL/MoPNG](https://en.wikipedia.org/wiki/Strategic_Petroleum_Reserve_(India)), [IEA](https://www.iea.org/about/oil-security-and-emergency-response).
