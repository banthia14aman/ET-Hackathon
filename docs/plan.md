...
4. **Venezuela number discrepancy:** the "292 kb/d" figure in our earlier brief does NOT match live sources (283-285 Apr / 427 May, agency-dependent). Store value+month+agency; display ranges. Fix before any slide ships.
...
2. **"In June 2026, India needed six days to answer one question."** 6-day timeline strip + cost-of-delay + "Not a data problem — a deliberation problem."
