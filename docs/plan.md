...
**Seeded assays (confirmed):** Murban 40.0 API / 0.78% S; Basrah Heavy 24.0 / 4.05 (Basrah Medium later removed from the dataset — post-2021 grade, the landmine-5 contaminant; unused by any spot cargo). Seeds to verify vs producer XLSX: Arab Light ~33.4/1.79, WTI Midland ~42/≤0.2, Urals ~31.7/1.7, Merey 16 ~16/2.45 (V ~400+ ppm = the demo-relevant killer dim), Girassol ~30/0.33, Cabinda ~32/0.17 (pour point = its killer dim), Tupi ~28.4/0.36, Das ~39/1.1.
