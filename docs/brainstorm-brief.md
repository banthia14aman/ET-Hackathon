...
**Minute-by-minute:** 0:00–0:40 stakes slide (June 2026 headline, "actual response: 6 days") → 0:40–1:30 signal fires, taxonomy auto-tag (`STRAIT-CLOSURE 4A — analogs: Abqaiq'19 0.87, RedSea'23 0.91`) → 1:30–2:20 graph cascade, refineries pulse red, days-of-cover tick → 2:20–3:30 **THE BEAT** (below) → 3:30–3:45 charter edit, cards re-sort with visible rule traces → 3:45–4:20 decision card zoom, stopwatch freezes ~4 min vs "India: 6 days," backtest stats flash → 4:20–5:00 architecture slide, close on the sentence.
