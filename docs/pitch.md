...
## Q&A bank (15 — rehearse all; 20-second answers)
...
15. **"Wasn't the six-day lag waiver-gated, not deliberation-gated? The OFAC waiver landed March 6th."** → "Partly — and that's exactly our point. The waiver unlocked *one* specific trade on the 6th; the collective action still took until the 10th, because the deliberation — which cargoes, which refineries, at what floor — hadn't happened. TRINETRA's value isn't predicting the waiver; it's having the fully-vetted, rules-cleared option set *ready the hour the waiver lands*. Policy gates when you may act; analysis gates what you do the moment you may. We compress the second gate — and when policy is the binding constraint, the charter shows it as an explicit branch, on the record."

*(If asked "did any practitioner review this?", the guard lives in docs/credibility-slide.md — deliver it verbatim.)*

**Target design partners (name them when asked "who's the buyer"):** IOC International Trade
Directorate (crude scheduling), Reliance Jamnagar crude trading desk, BPCL treasury/risk cell —
named as *targets*, not claimed conversations; the ask is one of the three as a design partner.
