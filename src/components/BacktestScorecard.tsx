          ...
          {CASES.map((c) => {
            ...
            return (
              <div key={c.id} className="bt-case">
                ...
                <div className="bt-row"><span className="bt-k">SIGNAL</span><span>{c.signal.event} <span className="bt-date mono">{c.signal.date}</span> <a href={c.signal.source_url} title={c.signal.source_org}>·src</a></span></div>
                <div className="bt-row"><span className="bt-k">MARKET DID</span><span>{c.market_reaction.what} <span className="bt-date mono">{c.market_reaction.date}</span> <a href={c.market_reaction.source_url} title={c.market_reaction.source_org}>·src</a></span></div>
